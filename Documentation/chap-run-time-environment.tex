...
returns true), then the first value is the function object. The second value
is the function definition type, that is: \texttt{cl:function},
\texttt{cl:macro-function} or \texttt{cl:special}. Otherwise values
\texttt{nil} and \texttt{nil} are returned.
